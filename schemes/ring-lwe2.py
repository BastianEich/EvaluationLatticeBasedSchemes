...
m = 1024   # Anzahl der Zeilen von 'A' und 'e' (= der in 'A' und 'e' enthaltenen Polynome)
k = 1024   # Anzahl der Koeffizienten in den Polynomen in 'A', 's' und 'e' ((k-1) ist der höchste Grad der Polynome
...
with open('results_rlwe2_size.txt', 'a') as g:
  g.write('s: %d  ' % size_s)
  g.write('A: %d  ' % size_A)
  g.write('B: %d  \n' % size_B)