...
# Ring Learning with Errors 1 - Key generation
...
m = 2048    # Number of rows of matrices 'A' and 'e' (= number of polynomials per matrix)
k = 1088    # Number of coefficients in the polynomials of matrices 'A', 's' and 'e' ((k-1) is the highest grade of polynomial)
